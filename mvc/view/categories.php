            ...
            <div class="row">
                <div class="wrap-content">
                    <?php
                        ...
                        $stmt = $conn -> query("SELECT * FROM product where id_cate = $id_cate AND status = 1 AND deleted = 0 limit 16 offset $offset ");
                        while ($row = $stmt->fetch()) {
                            echo '<div class="container">
                                <img src="../upload/uploads_product/'.$row['img'].'" class="img-fluid" alt="">
                                <div class="overlay">
                                <div class = "items"></div>
